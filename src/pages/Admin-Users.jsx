...
export const AdminUsers = () => {
    ...
    const getAllUsersData = async () => {
        try {
            const response = await fetch("https://mern01-server-tzr9.onrender.com/api/admin/users", {
                method: "GET",
                headers: {
    ...
    const deleteUser = async (id) => {
        try {
            const response = await fetch("https://mern01-server-tzr9.onrender.com/api/admin/users/delete/${id}", {
                method: "DELETE",
                headers: {
                    Authorization: authorizationToken,
                },
